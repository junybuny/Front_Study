// 할일 목록 추가 버튼을 눌렀을 때 할일 추가
function addTodoListClick(){
    // 추가버튼 클릭시 ul목록 찾아서
    // 추가하고자 하는 할일목록을 li 태그로 만들어서 넣어준다
    addTodo();
}

// 할일 목록 추가중 엔터를 클릭했을 때 할일 추가
...
function removeEvent(ev){
    ev.preventDefault(); // 이벤트의 기본 동작을 중단한다. == return false;
